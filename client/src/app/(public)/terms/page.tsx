        ...
        >
          <section className="bg-card border border-border rounded-2xl p-8">
            ...
            <p className="text-muted-foreground mb-4">
              By accessing and using HireIQ, you accept and agree to be bound by the terms and provision of this agreement. 
          ...
          <section className="bg-card border border-border rounded-2xl p-8">
            ...
            <p className="text-muted-foreground mb-4">
              Permission is granted to temporarily use HireIQ for personal, non-commercial transitory viewing only. 
          ...
          <section className="bg-card border border-border rounded-2xl p-8">
            ...
            <p className="text-muted-foreground mb-4">
              When you create an account on HireIQ, you are responsible for:
            </p>
            <div className="space-y-3">
              <div className="flex items-start gap-3">
          ...
          <section className="bg-card border border-border rounded-2xl p-8">
            ...
            <p className="text-muted-foreground mb-4">
              HireIQ provides a platform for property listings. We do not own, sell, or guarantee the properties listed. 
          ...
          <section className="bg-card border border-border rounded-2xl p-8">
            ...
            <p className="text-muted-foreground mb-4">
              HireIQ shall not be liable for any indirect, incidental, special, consequential, or punitive damages, 
          ...
          <section className="bg-card border border-border rounded-2xl p-8">
            ...
            <p className="text-muted-foreground">
              You agree to indemnify, defend, and hold harmless HireIQ and its officers, directors, employees, 
