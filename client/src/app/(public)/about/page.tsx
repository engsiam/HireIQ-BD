...
const team = [
  { 
    name: 'Rahul Ahmed', 
    role: 'CEO & Founder', 
    bio: 'Visionary leader with 15+ years in recruitment technology.',
    initials: 'RA'
  },
  { 
    name: 'Sarah Khan', 
    role: 'Head of Operations', 
    bio: 'Expert in streamlining hiring processes and candidate relations.',
    initials: 'SK'
  },
  { 
    name: 'Imran Hassan', 
    role: 'Lead AI Engineer', 
    bio: 'Dedicated to building intelligent job matching algorithms.',
    initials: 'IH'
  },
];
...
const milestones = [
  { 
    year: '2024', 
    title: 'Genesis of HireIQ BD', 
    description: 'Founded with a mission to revolutionize job matching in Bangladesh using AI.' 
  },
  { 
    year: '2024', 
    title: '5000+ Jobs Posted', 
    description: 'Reached our first major milestone of connecting job seekers with top employers.' 
  },
  { 
    year: '2025', 
    title: 'AI Innovation Award', 
    description: 'Recognized for our AI-powered CV analysis and job matching technology.' 
  },
  { 
    year: '2025', 
    title: '50k+ Job Seekers', 
    description: 'Building the largest career platform in Bangladesh.' 
  },
];
    ...
    <div className="bg-background min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-7xl font-black text-foreground leading-tight tracking-tighter">
              Transforming Careers with <span className="text-primary italic">AI</span>
            </h1>
            <p className="text-xl text-muted-foreground font-medium leading-relaxed">
              We bridge the gap between talented job seekers and top employers through 
              cutting-edge AI technology and unwavering commitment.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg font-medium leading-relaxed">
              To transform the recruitment landscape by providing a transparent, efficient, and 
              AI-powered platform for job matching in Bangladesh.
            </p>
            <ul className="mt-8 space-y-4">
              {['AI-Powered Matching', 'Verified Job Listings', 'Smart CV Analysis'].map((item) => (
          ...
          >
            ...
            <p className="text-muted-foreground text-lg font-medium leading-relaxed">
              To be the definitive destination for career opportunities, where innovation meets 
              unparalleled job matching for every professional in Bangladesh.
            </p>
            <div className="mt-12 p-6 bg-background rounded-2xl border border-border">
              <p className="text-primary font-black italic">"Leading the future of AI-powered recruitment."</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 bg-background border-y border-border">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            { label: 'Jobs Posted', value: '5,000+', icon: Rocket },
            { label: 'Job Seekers', value: '50,000+', icon: Users },
            { label: 'Companies', value: '1,200+', icon: Target },
