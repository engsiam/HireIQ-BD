...
export default function UserDashboard() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-10 space-y-6 lg:space-y-12 bg-background min-h-screen">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-8">
        <OverviewCard title="Bookings" value={stats.totalBookings} icon={Calendar} change="+12%" index={0} />
        <OverviewCard title="Wishlist" value={stats.wishlistCount} icon={Heart} change="+3 new" index={1} />
        <OverviewCard title="Spent" value={`৳${stats.totalSpent.toLocaleString()}`} icon={DollarSign} change="+24%" index={2} />
        <OverviewCard title="Active" value={stats.activeBookings} icon={Building2} change="Action" index={3} />
      </div>
