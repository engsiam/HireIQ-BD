    ...
    <div className="min-h-screen bg-[#0B0F1A] flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        >
          ...
          <p className="text-white/60 font-medium text-lg mb-12 max-w-md mx-auto">Your premium asset has been successfully secured. Welcome to the HireIQ community.</p>
